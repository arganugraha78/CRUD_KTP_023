 ...
 */
package gh.jogja.projek.ktp.coba;

import gh.jogja.projek.ktp.coba.exceptions.NonexistentEntityException;
import gh.jogja.projek.ktp.coba.exceptions.PreexistingEntityException;
...
public class DummyJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("gh.jogja_projek.ktp_jar_0.0.1-SNAPSHOTPU");

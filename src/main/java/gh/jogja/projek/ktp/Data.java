...
public class Data implements Serializable {
    ...
    public Data(Long id, String noktp, String nama, Date ttl, String jeniskelamin, String alamat, String agama, String status, String warganegara, String berlakuhingga) {
        this.id = id;
        this.noktp = noktp;
        this.nama = nama;
        this.ttl = ttl;
    ...
    public String toString() {
        return "gh.jogja.projek.ktp.Data[ id=" + id + " ]";
    }
